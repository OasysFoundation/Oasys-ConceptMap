...
let nodes = [{id: 0, label: "0", group: 0, fixed: {x: true, y:true}, x: 200, y: 200, physics:false},
    {id: 1, label: "1", group: 0},
    {id: 2, label: "2", group: 1},
    {id: 3, label: `say it with Symbols
    Algebra 1`, group: 1},
    ...
    {id: "ee", label: "eee3", group: 1},

    // {id: 9, label: "9", group: 3, mass: 10},
